...
class Course(models.Model):
    ...
    status = models.CharField(max_length=25, choices=CHOICES_STATUS, default=DRAFT)
    ...
    # if we don't have a url then we should return the default url

    def get_image(self):
        if self.image:
            return settings.WEBSITE_URL + self.image.url
        else:
            return "http://bulma.io/images/placeholders/1200x960.png"
...
class Comment(models.Model):
    ...
    course = models.ForeignKey(Lessons, related_name='comments', on_delete=models.CASCADE)
